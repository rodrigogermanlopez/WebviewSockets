...
public class Main extends Sprite {
	...
	private function init():void {
		...
		createCmd( ["close", "socketClose"], closeSocket, "closes the current connected socket; close | socketClose", "CLIENT" );
		createCmd( [
			"send",
			"socketSend"
		...
		createCmd( ["brodcast", "serverMessage"], sendServerMessage,"server sends a message to all connected clients.; brodcast msg(str)", "SERVER" ) ;
...
//		socketSendMessage( "hiserver" ) ;
	...
	private function createCmd( exec:*, fun:Function, description:String, group:String = "APP" ):void {

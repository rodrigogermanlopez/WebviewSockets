...
public final class CommandManager {
	...
	public function doCommand( command:ConsoleCommand, commandArgs:Vector.<CommandArgument> = null,
							   sub:Boolean = false ):* {
		if ( !commandArgs )
	...
	public function listCmd():void {
		var str:String = "Available APP commands: ";
	...
	public function listCommands( searchStr:String = "" ):void {
